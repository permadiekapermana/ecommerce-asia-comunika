...
?>
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="?page=riwayat">Riwayat Pembelian</a>
                    </nav>
                </div>
            </div>
        </div>
	...
	<section class="order_details section_gap">
		...
		<table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                        $tampil = mysql_query("SELECT * FROM orders WHERE u_pembeli = '$_SESSION[namauser]' AND (status_order = 'Selesai' OR status_order = 'Ditolak' OR status_order = 'Dibatalkan') ORDER BY no_invoice ASC");
