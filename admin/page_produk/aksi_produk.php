...
if (!empty($lokasi_file)){
  ...
  $Q=mysql_query("INSERT INTO produk (id_produk, produk, id_kategori, id_merek, harga, berat, stok, deskripsi, gambar) VALUES ('$id_produk', '$produk', '$id_kategori', '$id_merek', '$harga', '$berat', '$stok', '$deskripsi', '$nama_file_unik')");
  ...
  $Q=mysql_query("INSERT INTO produk (id_produk, produk, id_kategori, id_merek, harga, berat, stok, deskripsi) VALUES ('$id_produk', '$produk', '$id_kategori', '$id_merek', '$harga', '$berat', '$stok', '$deskripsi')");
  if($Q) {
    header('location:../menu.php?page='.$page);
  }
  else{
...
elseif ($page=='Produk' AND $act=='hapus'){
