...
$pel="RKMD.";
$y=substr($pel,0,4);
$query=mysql_query("select * from rekomendasi where substr(id_rekomendasi,1,4)='$y' order by id_rekomendasi desc limit 0,1");
$row=mysql_num_rows($query);
$data=mysql_fetch_array($query);
if ($row>0){
$no=substr($data['id_rekomendasi'],-6)+1;}
else{
$no=1;
}
$nourut=1000000+$no;
...
$aksi="page_rekomendasi/aksi_produk.php";
switch($_GET[act]){
default:
...
<div class='row'>
    <div class='col-md-12'>
        ...
        <a href='?page=RekomendasiProduk&act=pilihproduk'><button type='button' class='btn btn-primary'>Tambah</button></a>
        </div>
            <div class='card-body'>
            ...
            INNER JOIN `merek` ON `merek`.`id_merek` = `produk`.`id_merek` ORDER BY produk.id_produk DESC");
                ...
                <tr>
                    ...
                    <a href='$aksi?page=RekomendasiProduk&act=hapus&id=$r[id_produk]' class='btn btn-outline-danger btn-sm' onClick=\"return confirm('Yakin ingin hapus data ? Data yang dihapus tidak dapat dipulihkan !')\"><i class='fa fa-trash'></i></a>
                    </td>";                    
                    $no++;
                    }
                    echo"
            ...
            <tbody>";
              ...
              FROM
                ...
                <tr>
                    ...
                    <td width='105px'><img src='upload/produk/$r[gambar]' border='3' height='150' width='100'></td>
                    <td width='13%' align='center'>
                    <a href='$aksi?page=RekomendasiProduk&act=input&id=$r[id_produk]&id_rekomendasi=$nopel' class='btn btn-outline-success btn-sm' onClick=\"return confirm('Yakin ingin menambah produk ke rekomendasi produk toko ?')\"><i class='fa fa-pencil'> Pilih Produk</i></a>
                    </td>";                    
                    $no++;
                    }
                    echo"
