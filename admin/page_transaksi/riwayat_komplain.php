...
<div class='row'>
    <div class='col-md-12'>
        <div class='card'>
            ...
            <tbody>";
                $tampil = mysql_query("SELECT * FROM komplain WHERE status='Selesai' ORDER BY id_komplain ASC");
                ...
                <tr>
                    ...
                    <a href='?page=RiwayatKomplain&act=detail&id=$r[no_invoice]' class='btn btn-outline-primary btn-sm'><i class='fa fa-pencil'></i> Detail</a>
                    </td>";       
                    $no++;
                    }
                    echo"
