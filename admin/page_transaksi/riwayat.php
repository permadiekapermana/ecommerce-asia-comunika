...
<div class='row'>
    <div class='col-md-12'>
        <div class='card'>
            ...
            <tbody>";
                $tampil = mysql_query("SELECT * FROM orders WHERE status_order = 'Selesai' OR status_order = 'Ditolak' OR status_order = 'Dibatalkan' ORDER BY no_invoice ASC");
                ...
                <tr>
                    ...
                    <a href='?page=RiwayatPembelian&act=detail&id=$r[no_invoice]' class='btn btn-outline-primary btn-sm'><i class='fa fa-pencil'></i> Detail</a>
                    </td>";       
                    $no++;
                    }
                    echo"
...
<div class='row'>
    <div class='col-md-12'>
        ...
        <div class='col col-md-3'><label for='id_bank' class='form-control-label'>Nomor Invoice</label></div>
            ...
            <div class='row form-group'>
                <div class='col col-md-3'><label for='status_order' class='form-control-label'>Diverifikasi Oleh</label></div>
                <div class='col-9 col-md-6'><label for='status_order' class='form-control-label'>$r[u_toko]</label></div>
            </div>         
            ";
            }
            echo" <br>
